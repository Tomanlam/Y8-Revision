...
const VocabView: React.FC<VocabViewProps> = ({ unit: selectedUnit, onBack, sessionStats, setSessionStats, isShadowing }) => {
  ...
  return (
    <div className="flex-1 bg-transparent text-slate-800 flex flex-col overflow-hidden font-sans">
      <header className={`transition-all duration-500 ${isShadowing ? 'bg-emerald-500/25' : 'bg-white/[0.03]'} backdrop-blur-sm border-b border-white/10 p-4 sticky top-0 z-[100] shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)]`}>
