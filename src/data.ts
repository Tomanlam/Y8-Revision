...
export const units: Unit[] = [
  ...
  },
  {
    ...
    "concepts": [
      ...
      "Friction is a contact force that opposes the motion of a moving object because surfaces are rough.",
      "Tension is the pulling force in a rope, string, or thread that acts along its length.",
      "A free body diagram (FBD) uses arrows to show all forces acting on one object, where arrow length represents magnitude.",
      "Forces are balanced when they are equal in size and opposite in direction, resulting in no change in motion.",
      "Unbalanced forces cause changes in an object's speed or direction of motion.",
      "Speed describes how fast something moves and is calculated as distance divided by time (Speed = Distance ÷ Time).",
      "The standard unit of speed is metres per second (m/s).",
      "On a distance–time graph, a tilted straight line represents constant speed, while a horizontal line means the object is stationary.",
      ...
      "A moment is the turning effect of a force, calculated as force multiplied by the perpendicular distance from the pivot (Moment = Force × Distance).",
      "Moments are measured in newton metres (Nm).",
      "A seesaw is balanced when the clockwise moment equals the anticlockwise moment.",
      "Pressure describes how much force is applied over a given area (Pressure = Force ÷ Area).",
      "Pressure can be increased by increasing the force or decreasing the contact area (e.g., using a sharp object).",
      "Liquid pressure increases with depth because there is more liquid weight pushing down from above.",
      "Gas pressure is caused by gas particles colliding with the walls of their container.",
      "Air pressure decreases with altitude because the column of air above is shorter and less dense.",
      "A vacuum is a space with no particles, resulting in zero collisions and zero pressure.",
      "Increasing the temperature of a gas increases its pressure as particles move faster and collide more frequently.",
      "Brownian motion is the random zig-zag movement of particles caused by collisions with other particles.",
    ...
    "conceptsTraditional": [
      ...
      "摩擦力是一種接觸力，由於表面粗糙而抵抗運動物體的運動。",
      "張力是繩索、弦或線中的拉力，沿其長度方向作用。",
      "受力圖（FBD）使用箭頭顯示作用在一個物體上的所有力，箭頭長度代表大小。",
      "當力的大小相等且方向相反時，力是平衡的，導致運動沒有變化。",
      "不平衡的力會導致物體的速度或運動方向發生變化。",
      "速率描述物體移動的快慢，計算方法是距離除以時間（速率 = 距離 ÷ 時間）。",
      "速率的標準單位是米每秒（m/s）。",
      "在位移-時間圖上，傾斜的直線代表恆定速率，而水平線表示物體是靜止的。",
      "位移-時間圖的斜率或梯度代表物體的速率。",
      "槓桿是當施加力時繞支點轉動的物體。",
      "力矩是力的轉動效應，計算方法是力乘以與支點的垂直距離（力矩 = 力 × 距離）。",
      "力矩的單位是牛頓米（Nm）。",
      "當順時針力矩等於逆時針力矩時，蹺蹺板是平衡的。",
      "壓力描述在給定面積上施加了多少力（壓力 = 力 ÷ 面積）。",
      "可以通過增加力或減少接觸面積（例如使用鋒利的物體）來增加壓力。",
      "液體壓力隨深度增加而增加，因為上方有更多的液體重量向下推。",
      "氣體壓力是由氣體粒子與容器壁碰撞引起的。",
      "大氣壓力隨海拔升高而降低，因為上方的空氣柱更短且密度更低。",
      "真空是沒有粒子的空間，導致零碰撞和零壓力。",
      "增加氣體的溫度會增加其壓力，因為粒子移動得更快且碰撞更頻繁。",
      "布朗運動是由於與其他粒子碰撞而引起的粒子隨機鋸齒狀運動。",
      "擴散作用是粒子從高濃度區域向低濃度區域的淨移動。",
      "濃度是給定體積中的粒子數。",
    ...
    "conceptsSimplified": [
      ...
      "摩擦力是一种接触力，由于表面粗糙而抵抗运动物体的运动。",
      "张力是绳索、弦或线中的拉力，沿其长度方向作用。",
      "受力图（FBD）使用箭头显示作用在一个物体上的所有力，箭头长度代表大小。",
      "当力的大小相等且方向相反时，力是平衡的，导致运动没有变化。",
      "不平衡的力会导致物体的速度或运动方向发生变化。",
      "速率描述物体移动的快慢，计算方法是距离除以时间（速率 = 距离 ÷ 时间）。",
      "速率的标准单位是米每秒（m/s）。",
      "在位移-时间图上，倾斜的直线代表恒定速率，而水平线表示物体是静止的。",
      "位移-时间图的斜率或梯度代表物体的速率。",
      "杠杆是当施加力时绕支点转动的物体。",
      "力矩是力的转动效应，计算方法是力乘以与支点的垂直距离（力矩 = 力 × 距离）。",
      "力矩的单位是牛顿米（Nm）。",
      "当顺时针力矩等于逆时针力矩时，跷跷板是平衡的。",
      "压力描述在给定面积上施加了多少力（压力 = 力 ÷ 面积）。",
      "可以通过增加力或减少接触面积（例如使用锋利的物体）来增加压力。",
      "液体压力随深度增加而增加，因为上方有更多的液体重量向下推。",
      "气体压力是由气体粒子与容器壁碰撞引起的。",
      "大气压力随海拔升高而降低，因为上方的空气柱更短且密度更低。",
      "真空是没有粒子的空间，导致零碰撞和零压力。",
      "增加气体的温度会增加其压力，因为粒子移动得更快且碰撞更频繁。",
      "布朗运动是由于与其他粒子碰撞而引起的粒子随机锯齿状运动。",
      "扩散作用是粒子从高浓度区域向低浓度区域的净移动。",
      "浓度是给定体积中的粒子数。",
  ...
  },
  {
    ...
    "concepts": [
      ...
      "Ecology is the study of ecosystems, and scientists who study them are called ecologists.",
      "Producers (plants and algae) make food (glucose) via photosynthesis using carbon dioxide, water, and sunlight.",
      "Chlorophyll is the green pigment in plants used to capture sunlight for photosynthesis.",
      "Consumers cannot make their own food; herbivores eat plants, carnivores eat animals, and omnivores eat both.",
      "A habitat is the specific place where an organism naturally lives within an ecosystem.",
      "Adaptations are body features or behaviours that help organisms survive in their specific environment.",
      "Desert organisms have adaptations to minimize water loss from sweating or urination.",
      "Food chains show feeding relationships, where arrows indicate the direction of energy transfer.",
      "Food webs are more realistic models showing many interconnected food chains in an ecosystem.",
      "An apex predator is at the top of a food web and has no natural predators.",
      "Mangrove forests are coastal ecosystems where trees can grow in sea water and provide shelter for marine life.",
      "Arctic sea ice supports algae growth underneath, which forms the base of the food chain for seals and polar bears.",
      "Rice paddies are artificial (man-made) ecosystems where flooding and fertilizers support crop growth.",
      "Ecologists use sampling tools like pitfall traps (for crawling animals) and sweep nets (for flying insects) to study ecosystems.",
      "Native species originally live in a place, while invasive species are introduced and can harm the natural balance.",
      "Pests compete with humans for food, and pesticides (insecticides, herbicides, fungicides) are used to control them.",
      "Bioaccumulation is the build-up of persistent toxins in a single organism over its lifetime.",
      "Biomagnification is the increase in toxin concentration as it moves up the food chain to higher predators.",
    ...
    "conceptsTraditional": [
      ...
      "生態學是研究生態系統的科學，研究生態系統的科學家稱為生態學家。",
      "生產者（植物和藻類）利用二氧化碳、水和陽光通過光合作用製造食物（葡萄糖）。",
      "葉綠素是植物中用於捕獲陽光進行光合作用的綠色色素。",
      "消費者不能自己製造食物；草食性動物吃植物，肉食性動物吃動物，雜食性動物兩者都吃。",
      "棲息地是生物在生態系統中自然生活的特定場所。",
      "適應特徵是幫助生物在其特定環境中更好地生存的身體特徵或行為。",
      "沙漠生物具有減少因出汗或排尿而流失水分的適應特徵。",
      "食物鏈顯示了攝食關係，其中箭頭表示能量轉移的方向。",
      "食物網是更真實的模型，顯示了生態系統中許多相互關聯的食物鏈。",
      "頂級掠食者位於食物網的頂端，沒有天敵。",
      "紅樹林是沿海生態系統，樹木可以在海水中生長並為海洋生物提供庇護所。",
      "北極海冰支持其下方的藻類生長，這構成了海豹和北極熊食物鏈的基礎。",
      "稻田是人造（人工）生態系統，通過灌溉和肥料支持作物生長。",
      "生態學家使用取樣工具，如陷阱（用於爬行動物）和掃網（用於飛行昆蟲）來研究生態系統。",
      "原生物種是最初自然生活在某地的物種，而入侵物種是被引入並可能破壞自然平衡的物種。",
      "害蟲與人類競爭食物，使用農藥（殺蟲劑、除草劑、殺真菌劑）來控制它們。",
      "生物累積是指持久性毒素在單個生物體內隨時間的累積。",
      "生物放大作用是指毒素濃度隨著食物鏈向高級掠食者轉移而增加。",
    ...
    "conceptsSimplified": [
      ...
      "生态学是研究生态系统的科学，研究生态系统的科学家称为生态学家。",
      "生产者（植物和藻类）利用二氧化碳、水和阳光通过光合作用制造食物（葡萄糖）。",
      "叶绿素是植物中用于捕获阳光进行光合作用的绿色色素。",
      "消费者不能自己制造食物；草食性动物吃植物，肉食性动物吃动物，杂食性动物两者都吃。",
      "栖息地是生物在生态系统中自然生活的特定场所。",
      "适应特征是帮助生物在其特定环境中更好生存的身体特征或行为。",
      "沙漠生物具有减少因出汗或排尿而流失水分的适应特征。",
      "食物链显示了摄食关系，其中箭头表示能量转移的方向。",
      "食物网是更真实的模型，显示了生态系统中许多相互关联的食物链。",
      "顶级掠食者位于食物网的顶端，没有天敌。",
      "红树林是沿海生态系统，树木可以在海水中生长并为海洋生物提供庇护所。",
      "北极海冰支持其下方的藻类生长，这构成了海豹和北极熊食物链的基础。",
      "稻田是人造（人工）生态系统，通过灌溉和肥料支持作物生长。",
      "生态学家使用取样工具，如陷阱（用于爬行动物）和扫网（用于飞行昆虫）来研究生态系统。",
      "原生物种是最初自然生活在某地的物种，而入侵物种是被引入并可能破坏自然平衡的物种。",
      "害虫与人类竞争食物，使用农药（杀虫剂、除草剂、杀真菌剂）来控制它们。",
      "生物累积是指持久性毒素在单个生物体内随时间的累积。",
      "生物放大作用是指毒素浓度随着食物链向高级掠食者转移而增加。",
